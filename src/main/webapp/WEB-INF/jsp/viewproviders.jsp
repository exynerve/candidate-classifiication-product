...
var providers_end_point_with_appname_logintype_customer='<%=Messages.EndPoints.FETCH_PROVIDERS_END_POINT_APPNAME_CUSTOMER_LOGINTYPE%>'



</script>
<script type="text/javascript" src="<%=request.getContextPath()%>/extjs41/bootstrap.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/customjs/viewproviders.js"></script>
