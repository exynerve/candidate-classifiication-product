...
var view_questions_endpoints='<%=Messages.EndPoints.FETCH_QUESTIONS_ENDPOINT%>'
</script>
<script type="text/javascript" src="<%=request.getContextPath()%>/extjs41/bootstrap.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/customjs/viewquestions.js"></script>
