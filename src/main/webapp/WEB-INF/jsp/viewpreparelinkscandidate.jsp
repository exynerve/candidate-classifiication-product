...
var view_preparelinks_endpoints='<%=Messages.EndPoints.FETCH_PREPARELINK_ENDPOINT%>'
</script>
<script type="text/javascript" src="<%=request.getContextPath()%>/extjs41/bootstrap.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/customjs/viewpreparelinks.js"></script>
