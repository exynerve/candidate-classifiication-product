...
<div class="container" ng-app="registerUserApp" id="contentContainer">
 ...
 <div class="panel panel-primary">
    ...
    <div ng-controller="registerUserController" class="main-content-wrapper">
		...
		<!-- Start of Row -->
		 ...
		 <div class="row"> <!-- Start of 2nd Row -->
            ...
            <div class="col-lg-4 col-md-4 col-xs-12  col-sm-12">
                    ...
                    <select class="form-control" ng-model="register.gender">
		...
		<div class="row"><!-- Start of 4th Row -->
			...
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
				...
				<button type="submit" class="productBtn" ng-click="register_user()">Register User</button>
